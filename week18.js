...
// function makeTwo() {
// 	window.localStorage.setItem('number','7,6,5');
...
// function makeThree() {
// 	window.localStorage.setItem('John','name=John,age=25');
...
// function makeFour() {
// 	//Ваш код
// 	window.localStorage.setItem('Логическое значение','true');
...
// function makeFive() {
// 	//Ваш код
// 	window.localStorage.setItem('отсутствие денных','null');
...
// 		  price: 199
// 		};
// 	const fruit = JSON.stringify(obj);
// 	window.localStorage.setItem('objectEight', fruit);
// 	console.log('Объект obj был записан в Local Storage.');
// }
...
// function showEleven() {
// 	const keyItem = window.localStorage.getItem('arrayEleven');
// 	const arrayEleven = JSON.parse(keyItem);
// 	let output = '';
...
// const showEight = () => {
// 	const arrayString = window.localStorage.getItem('objectEight');
// 	if(arrayString) {
// 		const objectEight = JSON.parse(arrayString);
...
// 	const objString = window.localStorage.getItem('objectSeven');
// 	const objectSeven = JSON.parse(objString);

// 	const resultElement = document.querySelector('.practicum16');
// 	resultElement.innerHTML = `В ${objectSeven.city}e живёт ${objectSeven.population} человек`;
// };
...
// const showSix = () => {
// 	const objString = window.localStorage.getItem('objectSix');
// 	const objectSix = JSON.parse(objString);
...
// 	window.localStorage.setItem('task19',numbers);
// };
...
// 	if (numbers.length > 0) {
// 		numbers.pop();
// 		window.localStorage.setItem('task20',numbers);
...
// 	cartItems.pop();
// 	const arrJSON = JSON.stringify(cartItems);
// 	window.localStorage.setItem('cartItems',arrJSON)
// };
...
// 		const arr = cartItems[i];
// 		document.querySelector('.practicum23').textContent += `${arr} ,`;
// 		}
// 	};
...
// 	document.querySelector('.practicum24').innerHTML = `Количество товаров в корзине ${cartItems.length}`
// };
...
// 		cook = cook.split('=');
// 		if (cook.length == 2 && cook[0] == 'username') {
// 			username = cook[1];
// 		}
// 	}
